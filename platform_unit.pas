...
const
  ...
  +' It is not possible for Templot to show adjacent rails and platforms on the same template.'
...
begin
  ...
  if getdims('turnout - side  platform  position',platform_help_str,platform_form,n,od)=True
     then begin
            ...
            platform_ts_length_mm:=od[1];
            if platform_ts_length_mm=def_req then platform_ts_length_mm:=(0-1);  // converted in strails();
...
begin
  ...
  if getdims('main - side  platform  position',platform_help_str,platform_form,n,od)=True
     then begin
            ...
            if platform_ms_length_mm=def_req then platform_ms_length_mm:=(0-1);     //  converted in strails(); to full template length.
