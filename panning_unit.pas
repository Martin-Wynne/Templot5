...
type
  Tpanning_form = class(TForm)
    ...
    procedure up_panbuttonMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    ...
    procedure set_label4MouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure set_label4MouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure set_label3MouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure set_label3MouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure set_label2MouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure set_label2MouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure set_label1MouseDown(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure set_label1MouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
...
const
  ...
  +'||Most of the time in Templot you will probably prefer to pan across the trackpad by dragging it with the mouse or by using the arrow keys on the keyboard.'
  +'||And most of the time in Templot you will probably prefer to zoom the trackpad by means of the mouse wheel.'
  ...
  +'||If the `0EDGE-PANNING > ON`1 option button is currently selected (or the `0TRACKPAD > ZOOM AND PAN OPTIONS > EDGE PANNING ON`1 menu item is currently selected),'
...
begin
  if scale_zoom_checkbox.Checked=True
     then pad_form.adjust_zoom_menu_entry.Click
     else pad_form.adjust_spot_zoom_menu_entry.Click;
end;
//______________________________________________________________________________
