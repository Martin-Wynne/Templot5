...
type
  Tinfo_form = class(TForm)
    ...
    timber_lengths_button: TButton;
    rounding_checkbox: TCheckBox;
    ...
    procedure timber_lengths_buttonClick(Sender: TObject);
    procedure rounding_checkboxClick(Sender: TObject);
  private
...
begin
  ...
  ClientHeight:=shrink_button.Top;       // 0.93.a was -1
...
begin
  ...
  if new=True then get_new_ref_name;
...
procedure Tinfo_form.timber_lengths_buttonClick(Sender: TObject);   // 227a
...
procedure Tinfo_form.rounding_checkboxClick(Sender: TObject);

begin
  redraw(True);   // update rounding of smallest-radius info
end;
//______________________________________________________________________________
